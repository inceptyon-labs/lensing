...
export type WsMessageType = 'layout_change' | 'plugin_data' | 'scene_change' | 'ping' | 'pong' | 'ask_response' | 'agent_request' | 'agent_response' | 'data_snapshot_request' | 'data_snapshot_response';
...
export type { AiNewsSummary, AiNewsData, AiNewsRssFetchFn, SummarizeFn, AiNewsServerOptions, AiNewsServerInstance, } from './ai-news';
...
export type { WordOfDayData, WotdFetchFn, WordOfDayServerOptions, WordOfDayServerInstance, } from './word-of-day';
export type { SportsGame, GameStatus, LeagueConfig, SportsData, SportsServerOptions, SportsServerInstance, } from './sports';
export { DEFAULT_SPORTS_MAX_STALE_MS, DEFAULT_SPORTS_LEAGUES } from './sports';
export type { ConfigExportV1, ConfigExport, ImportResult, ConfigMigration, ConfigTransferOptions, ConfigTransferInstance, } from './config-transfer';
...
export type { StockQuote, FinanceData, FinanceServerOptions, FinanceServerInstance, } from './finance';
 ...
 */
export declare function isValidConnectorConfig(value: unknown): value is ConnectorConfig;
