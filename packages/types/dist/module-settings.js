...
export const MODULE_SCHEMAS = [
    ...
    },
    {
        ...
        setupGuide: 'Uses the free CoinGecko API — no API key needed.\n\n' +
    ...
    },
    {
        ...
        setupGuide: 'Add RSS feed URLs separated by commas. No API key needed — this reads public RSS feeds directly.\n\n' +
    ...
    },
    {
        ...
        setupGuide: 'Uses the free ESPN API — no API key needed.\n\n' +
        ...
        fields: [
            ...
            },
            {
                ...
                description: 'Comma-separated team names to filter (e.g. Buccaneers,Gators,Lakers). Leave blank for all games.',
                category: 'widget',
            },
        ],
    },
    {
        ...
        setupGuide: 'Connects to any CalDAV server (iCloud, Google via CalDAV, Nextcloud, Radicale, etc.).\n\n' +
            'For iCloud:\n' +
    ...
    },
    {
        ...
        setupGuide: 'Connects to your Home Assistant instance to display entity states.\n\n' +
    ...
    },
    {
        ...
        setupGuide: 'Uses pollen.com for real-time pollen data — no API key needed.\n\n' +
    ...
    },
    {
        ...
        system: true,
        setupGuide: 'Controls the display backlight using a passive infrared (PIR) motion sensor.\n\n' +
    ...
    },
    {
        ...
        setupGuide: 'Pick news categories below and choose how often to refresh.\n\n' +
    ...
    },
    {
        ...
        setupGuide: 'Uses Yahoo Finance — no API key needed.\n\n' +
...
export function moduleNeedsIntegration(schema) {
