...
import { DEFAULT_KEN_BURNS_CONFIG, DEFAULT_CYCLE_INTERVAL_MS, SUPPORTED_IMAGE_EXTENSIONS, } from '../photo-slideshow';
describe('PhotoSlideshow Types & Constants', () => {
    ...
    it('should export DEFAULT_KEN_BURNS_CONFIG with valid animation params', () => {
        ...
        expect(DEFAULT_KEN_BURNS_CONFIG.scale[0]).toBeLessThanOrEqual(DEFAULT_KEN_BURNS_CONFIG.scale[1]);
...
//# sourceMappingURL=photo-slideshow.test.js.map