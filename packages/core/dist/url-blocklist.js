 ...
 */
export function getBlockReason(urlString, options = {}) {
    let hostname;
    try {
 ...
 */
export function isBlockedUrl(urlString, options = {}) {
    return getBlockReason(urlString, options) !== null;
}
//# sourceMappingURL=url-blocklist.js.map