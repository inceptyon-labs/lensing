...
describe('DataBus', () => {
    ...
    describe('publish and subscribe', () => {
        ...
        it('should deliver multiple publishes to subscribers', () => {
            ...
            expect(callback.mock.calls[0][0].data).toEqual({ temp: 72 });
            expect(callback.mock.calls[1][0].data).toEqual({ temp: 75 });
        });
    });
    describe('immutable snapshots', () => {
        ...
        it('should not allow mutation of published data across subscribers', () => {
            ...
            const msg1 = cb1.mock.calls[0][0];
            const msg2 = cb2.mock.calls[0][0];
    ...
    describe('onMessage (global listener for WS forwarding)', () => {
        it('should call global listeners on every publish', () => {
            ...
            expect(globalCb.mock.calls[0][0].channel).toBe('weather.current');
            expect(globalCb.mock.calls[1][0].channel).toBe('calendar.today');
        });
...
//# sourceMappingURL=data-bus.test.js.map