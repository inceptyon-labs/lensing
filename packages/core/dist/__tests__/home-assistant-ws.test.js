...
function doHaHandshake(ws, _token) {
    ws._simulateOpen();
...
describe('Home Assistant Server — WebSocket', () => {
    ...
    it('should connect to ws url derived from http url', () => {
        ...
        const wsUrl = wsFn.mock.calls[0][0];
    ...
    it('should send auth message with token after receiving auth_required', () => {
        ...
        const authMsg = mockWs._sentMessages.find((m) => typeof m === 'object' && m !== null && m.type === 'auth');
    ...
    it('should subscribe to state_changed events after auth_ok', () => {
        ...
        const subscribeMsg = mockWs._sentMessages.find((m) => typeof m === 'object' && m !== null && m.type === 'subscribe_events');
...
//# sourceMappingURL=home-assistant-ws.test.js.map