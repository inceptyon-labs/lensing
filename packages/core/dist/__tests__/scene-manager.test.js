...
describe('SceneManager', () => {
    ...
    describe('default scenes', () => {
        ...
        it('should export default scenes for reuse', () => {
            ...
            expect(DEFAULT_SCENES.map((s) => s.name)).toEqual(expect.arrayContaining(['morning', 'evening', 'ambient', 'focus', 'alert']));
        });
...
//# sourceMappingURL=scene-manager.test.js.map