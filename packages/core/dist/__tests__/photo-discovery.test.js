...
import { discoverPhotos, calculateKenBurnsTransform, getNextPhotoIndex, } from '../plugins/photo-slideshow/index';
...
describe('Photo Discovery & Cycling', () => {
    ...
    it('should discover photos from directory', () => {
        ...
        expect(photos.map((p) => path.basename(p))).toEqual(expect.arrayContaining(['photo1.jpg', 'photo2.png', 'photo3.webp']));
    });
...
//# sourceMappingURL=photo-discovery.test.js.map