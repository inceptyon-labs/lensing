...
describe('MarketplaceClient', () => {
    ...
    it('respects configurable marketplace repo URL', async () => {
        ...
        await client.getIndex();
        expect(mockFetch).toHaveBeenCalledWith('https://raw.githubusercontent.com/custom-org/custom-repo/main/index.json');
    });
    ...
    it('should reject marketplaceRepo with path traversal', () => {
        expect(() => createMarketplaceClient({
            cacheDir: tempCacheDir,
...
//# sourceMappingURL=marketplace-client.test.js.map