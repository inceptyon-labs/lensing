...
describe('Database', () => {
    ...
    describe('layouts CRUD', () => {
        ...
        it('should get all layouts', () => {
            const layoutA = [{ zone: 'center', columns: 2, rows: 2, plugins: ['clock'] }];
            const layoutB = [{ zone: 'top-bar', columns: 4, rows: 1, plugins: ['status'] }];
    ...
    describe('security and edge cases', () => {
        it('should protect against prototype pollution via __proto__ in layouts', () => {
            const layout = [{ zone: 'center', columns: 2, rows: 2, plugins: ['test'] }];
