...
describe('savePluginFromBuilder', () => {
    ...
    it('throws when version is missing', async () => {
        await expect(savePluginFromBuilder(validInput({ version: '' }), tmpDir)).rejects.toThrow(/version/i);
    });
    it('throws when plugin directory already exists without overwrite flag', async () => {
        ...
        await expect(savePluginFromBuilder(validInput(), tmpDir)).rejects.toThrow(/already.*exist|conflict/i);
    });
...
//# sourceMappingURL=plugin-save.test.js.map