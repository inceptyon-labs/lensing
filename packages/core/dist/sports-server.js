...
function transformEvent(event, league) {
    ...
    const periodStr = statusType.state === 'in' && period
...
export function createSportsServer(options) {
    ...
    function matchesTeamFilter(game) {
    ...
    async function refresh() {
        ...
        try {
            ...
            dataBus.publish(DATA_BUS_SCORES_CHANNEL, PLUGIN_ID, publishData);
...
//# sourceMappingURL=sports-server.js.map