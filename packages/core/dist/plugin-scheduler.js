...
export function createPluginScheduler(options = {}) {
    ...
    function scheduleNext(record, capturedGeneration, delay) {
    ...
    return {
        register(pluginId, manifest, handler, overrideInterval) {
            ...
            const floorInterval = manifestInterval !== undefined && Number.isFinite(manifestInterval) && manifestInterval > 0
                ? manifestInterval
                : defaultInterval;
            let interval;
...
//# sourceMappingURL=plugin-scheduler.js.map