...
- packages/core/src/__tests__/rest-server.test.ts (new) — 12 tests covering health, CORS, logging, error cases
- packages/core/src/index.ts (modified) — exports createRestServer and related types
- packages/core/src/__tests__/imports.test.ts (modified) — added export verification tests
