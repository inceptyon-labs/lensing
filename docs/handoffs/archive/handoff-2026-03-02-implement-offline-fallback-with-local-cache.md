...
- packages/core/src/__tests__/marketplace-client.test.ts — Updated tests for timestamp
- packages/core/src/__tests__/rest-server-marketplace.test.ts — Added offline fallback tests
- packages/types/src/__tests__/index.test.ts — Added MarketplaceIndex type tests
