...
- apps/display/src/__tests__/grapes-style-manager.test.ts (new) — 30 tests
- apps/display/src/__tests__/grapes-templates.test.ts (new) — 18 tests
- apps/display/src/__tests__/widget-template-picker.test.ts (new) — 6 tests
- apps/display/src/__tests__/grapesjs-editor.test.ts — added StyleManager mock + 1 test
