...
- packages/core/src/__tests__/secret-crypto.test.ts (NEW)
- packages/core/src/__tests__/database-secrets.test.ts (NEW)
- packages/core/src/__tests__/secret-store.test.ts (NEW)
- packages/core/src/secret-store.ts (NEW)
- packages/core/src/database.ts (migration v3 + 5 new methods)
- packages/core/src/__tests__/database.test.ts (updated v2→v3 assertions)
