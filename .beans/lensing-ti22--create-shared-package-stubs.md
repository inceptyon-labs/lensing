...
- packages/types/vitest.config.ts, src/__tests__/index.test.ts (new) — 8 type contract tests
...
- packages/core/src/__tests__/imports.test.ts (new) — 2 cross-package import tests
