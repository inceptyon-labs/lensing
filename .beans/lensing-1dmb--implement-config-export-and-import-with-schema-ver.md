...
updated_at: 2026-02-22T11:52:46Z
parent: lensing-kd62
---
...
packages/types/src/**tests**/config-transfer.test.ts (6 tests)
packages/types/src/index.ts (exports)
packages/core/src/config-transfer.ts (factory module)
packages/core/src/**tests**/config-transfer.test.ts (24 tests)
packages/core/src/**tests**/config-transfer-integration.test.ts (3 tests)
...
Object.create(null) for intermediate maps to prevent **proto** key data loss
...
ESLint downgraded from 10.0.0 → 9.39.3 due to typescript-eslint incompatibility
