...
- packages/core/src/__tests__/allergies-server.test.ts (421 LOC) - 26 tests covering all scenarios
- packages/ui/src/allergies-store.ts (130 LOC) - UI store with severity colors/labels
- packages/ui/src/__tests__/allergies-store.test.ts (232 LOC) - 29 tests
