...
- packages/core/src/**tests**/connector-proxy.test.ts (296 lines new) - 21 unit tests covering validation, SSRF, JSON/RSS, errors, timeouts
- packages/core/src/**tests**/rest-server-builder.test.ts (201 lines new) - 6 integration tests for REST endpoint
