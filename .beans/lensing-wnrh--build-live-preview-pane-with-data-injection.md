...
- apps/display/src/**tests**/builder-preview.test.ts (185 lines, new) — 15 tests covering all acceptance criteria
- apps/display/src/lib/GrapesJSEditor.svelte (modified) — added onChange prop for live preview updates
- apps/display/src/**tests**/grapesjs-editor.test.ts (82 lines, new) — 5 tests for onChange callback using mocked grapesjs
