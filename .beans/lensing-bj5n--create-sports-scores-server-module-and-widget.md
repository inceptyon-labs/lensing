...
updated_at: 2026-02-22T03:19:04Z
parent: lensing-s32t
---
...
- packages/types/src/**tests**/sports.test.ts (6 tests)
- packages/core/src/sports-server.ts (ESPN API integration, fetch timeout, malformed event isolation)
- packages/core/src/**tests**/sports-server.test.ts (23 tests)
- packages/core/src/**tests**/sports-integration.test.ts (4 tests)
...
- packages/ui/src/**tests**/sports-store.test.ts (17 tests)
- apps/display/src/lib/SportsScores.svelte (widget, live indicator, compact mode)
- apps/display/**tests**/sports-scores.test.ts (13 tests)
