...
- apps/display/src/**tests**/canvas-sizes.test.ts (49 lines, new) — 7 unit tests for canvas-sizes module
- apps/display/src/lib/GrapesJSEditor.svelte (14 lines added) — Size toggle UI with onSizeChange callback
- apps/display/src/**tests**/grapesjs-editor.test.ts (84 lines added) — 6 size toggle integration tests
