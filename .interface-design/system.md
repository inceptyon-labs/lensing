...
--edge-bright:    hsla(220, 10%, 50%, 0.20);  /* emphasis — active panels */
--edge-focus:     hsla(28, 85%, 55%, 0.40);   /* focus rings — ember-tinted */
```
...
box-shadow: 0 0 0 1px var(--edge-bright), 0 0 20px var(--ember-trace);

/* Focused card — clear ember edge */
box-shadow: 0 0 0 1px var(--edge-focus), 0 0 24px hsla(28, 85%, 55%, 0.08);
```
