...
export function registerWidgetBlocks(editor: unknown): void {
  ...
  ed.BlockManager.add('widget-text', {
    label: 'Text',
    category: 'Widget',
    content: '<p style="color: var(--starlight, #e2e4ed); font-size: 16px; margin: 0; line-height: 1.5;">Enter text here</p>',
  ...
  ed.BlockManager.add('widget-heading', {
    label: 'Heading',
    category: 'Widget',
    content: '<h2 style="color: var(--starlight, #e2e4ed); font-size: 24px; font-weight: 700; margin: 0; line-height: 1.2;">Heading</h2>',
  ...
  ed.BlockManager.add('widget-value', {
    label: 'Value',
    category: 'Widget',
    content: '<span style="color: var(--starlight, #e2e4ed); font-size: 48px; font-weight: 700; display: block; line-height: 1;">42</span>',
  ...
  ed.BlockManager.add('widget-list', {
    label: 'List',
    category: 'Widget',
    content: '<ul style="color: var(--starlight, #e2e4ed); font-size: 16px; margin: 0; padding-left: 20px; list-style-type: disc;"><li>Item one</li><li>Item two</li><li>Item three</li></ul>',
  ...
  ed.BlockManager.add('widget-divider', {
    label: 'Divider',
    category: 'Widget',
    content: '<hr style="border: none; border-top: 1px solid var(--edge, rgba(140,145,160,0.12)); margin: 8px 0;" />',
  ...
  ed.BlockManager.add('widget-icon', {
    label: 'Icon',
    category: 'Widget',
    content: '<span style="color: var(--dim-light, #909bb8); font-size: 24px; display: inline-block; line-height: 1;">★</span>',
